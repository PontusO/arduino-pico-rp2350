...
bool __attribute__((weak)) running_on_fpga() {
    return (*(io_ro_32 *)TBMAN_BASE) & TBMAN_PLATFORM_FPGA_BITS;
}
#endif
// weak as we have a better copy in tb.c for amy_testcases (note this is only here at all beacuse of hack in TinyUSB for sim)
int __attribute__((weak)) running_in_sim() {
