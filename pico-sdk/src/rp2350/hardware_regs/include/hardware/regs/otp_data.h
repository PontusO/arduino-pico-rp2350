...
#define OTP_DATA_CHIPID_DEVICE0_ROW    _u(0x00000000)
...
#define OTP_DATA_CHIPID_DEVICE1_ROW    _u(0x00000001)
...
#define OTP_DATA_CHIPID_WAFER0_ROW    _u(0x00000002)
...
#define OTP_DATA_CHIPID_WAFER1_ROW    _u(0x00000003)
...
//               re-enables the factory test JTAG interface, and makes pages 3
