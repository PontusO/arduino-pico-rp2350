...
// Reference to datasheet: https://datasheets.raspberrypi.com/rp2040/rp2040-datasheet.pdf#tab-registerlist_trng
//
...
typedef struct {
    ...
    // Interrupt masking
    // 0xfffffff0 [31:4]  : RESERVED (0): RESERVED
    ...
    // 0x00000001 [0]     : EHR_VALID (0): 1'b1 indicates that 192 bits have been collected in the RNG, and are ready to be read
    io_ro_32 rng_isr;
    ...
    // 0xfffffffc [31:2]  : RESERVED (0): RESERVED
    // 0x00000003 [1:0]   : RND_SRC_SEL (0): Selects the number of inverters (out of four possible selections) in the ring...
    io_rw_32 trng_config;

    _REG_(TRNG_TRNG_VALID_OFFSET) // TRNG_TRNG_VALID
    // 192 bit collection indication
    // 0xfffffffe [31:1]  : RESERVED (0): RESERVED
    // 0x00000001 [0]     : EHR_VALID (0): 1'b1 indicates that collection of bits in the RNG is completed, and data can be...
    io_ro_32 trng_valid;
    ...
    // 0xffffffff [31:0]  : SAMPLE_CNTR1 (0xffff): Sets the number of rng_clk cycles between two consecutive ring oscillator samples
    ...
    // 0xffc00000 [31:22] : RESERVED (0): RESERVED
    // 0x003fc000 [21:14] : AUTOCORR_FAILS (0): Count each time an autocorrelation test fails
    // 0x00003fff [13:0]  : AUTOCORR_TRYS (0): Count each time an autocorrelation test starts
    ...
    // 0x00000002 [1]     : VNC_BYPASS (0): When set, the Von-Neuman balancer is bypassed (including the 32 consecutive bits test)
    ...
    // 0xfffffffe [31:1]  : RESERVED (0): RESERVED
    // 0x00000001 [0]     : RST_BITS_COUNTER (0): Writing any value to this address will reset the bits counter and RNG...
    io_rw_32 rst_bits_counter;

    _REG_(TRNG_RNG_VERSION_OFFSET) // TRNG_RNG_VERSION
    // Displays the version settings of the TRNG
    // 0xffffff00 [31:8]  : RESERVED (0): RESERVED
    ...
    // 0xffc00000 [31:22] : RESERVED (0): RESERVED
    // 0x003fffff [21:0]  : ROSC_CNTR_VAL (0): Reflects the results of RNG BIST counter
    io_ro_32 rng_bist_cntr_0;

    _REG_(TRNG_RNG_BIST_CNTR_1_OFFSET) // TRNG_RNG_BIST_CNTR_1
    // Collected BIST results
    // 0xffc00000 [31:22] : RESERVED (0): RESERVED
    // 0x003fffff [21:0]  : ROSC_CNTR_VAL (0): Reflects the results of RNG BIST counter
    io_ro_32 rng_bist_cntr_1;

    _REG_(TRNG_RNG_BIST_CNTR_2_OFFSET) // TRNG_RNG_BIST_CNTR_2
    // Collected BIST results
    // 0xffc00000 [31:22] : RESERVED (0): RESERVED
    // 0x003fffff [21:0]  : ROSC_CNTR_VAL (0): Reflects the results of RNG BIST counter
    io_ro_32 rng_bist_cntr_2;
} trng_hw_t;
