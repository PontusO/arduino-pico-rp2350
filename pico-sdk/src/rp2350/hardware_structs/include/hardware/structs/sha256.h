...
// Reference to datasheet: https://datasheets.raspberrypi.com/rp2040/rp2040-datasheet.pdf#tab-registerlist_sha256
//
...
typedef struct {
    ...
    // 0x00001000 [12]    : BSWAP (1): Enable byte swapping of 32-bit values at the point they are committed to the SHA...
    // 0x00000300 [9:8]   : DMA_SIZE (0x2): Configure DREQ logic for the correct DMA data size
    // 0x00000010 [4]     : ERR_WDATA_NOT_RDY (0): Set when a write occurs whilst the SHA-256 core is not ready for data...
    // 0x00000004 [2]     : SUM_VLD (1): If 1, the SHA-256 checksum presented in registers SUM0 through SUM7 is currently valid
    // 0x00000002 [1]     : WDATA_RDY (1): If 1, the SHA-256 core is ready to accept more data through the WDATA register
