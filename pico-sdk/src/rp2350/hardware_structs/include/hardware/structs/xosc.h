...
typedef struct {
    ...
    // 0x00000fff [11:0]  : FREQ_RANGE (0): The 12-bit code is intended to give some protection against accidental writes
    io_rw_32 ctrl;
    ...
    // 0x00000003 [1:0]   : FREQ_RANGE (0): The current frequency range setting
    io_rw_32 status;
    ...
    // 0x00100000 [20]    : X4 (0): Multiplies the startup_delay by 4, just in case
