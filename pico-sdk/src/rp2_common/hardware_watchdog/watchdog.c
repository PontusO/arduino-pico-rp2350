...
void _watchdog_enable(uint32_t delay_ms, bool pause_on_debug) {
    valid_params_if(WATCHDOG, delay_ms <= WATCHDOG_LOAD_BITS / (1000 * WATCHDOG_XFACTOR));
